$(document).ready(function () {
  ...
  $("#gnb>li").on("mouseenter", function () {
    ...
    // find 와 children의 차이점 : find는 모두 찾는다, children은 직계자식만 찾는다. 여기선 find 사용불가.
  });
  $("#gnb>li").on("mouseleave", function () {
    $(this).children("a").removeClass("on");
  });

  // gnb에 마우스를 올린상태라면 bgGnb를 만들어 달라는 코드
  $("#gnb").on("mouseenter", function () {
    /* 무한반복해서 .bgGnb를 생성하지 않도록 변수로 해당 클래스의 여부를 담은 뒤 if문으로 해당 클래스의 존재에 따라서 한번만 생성하도록 코드를 작성 */
